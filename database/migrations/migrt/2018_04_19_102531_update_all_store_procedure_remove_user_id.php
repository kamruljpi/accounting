...
class UpdateAllStoreProcedureRemoveUserId extends Migration
{
    /**
     * Run the migrations.
     *
...
limit startedAt,limits;");
        ...
        DB::unprepared("DROP procedure IF EXISTS get_product_with_packet_and_unit");
        DB::unprepared("CREATE DEFINER=`root`@`localhost` PROCEDURE `get_product_with_packet_and_unit`(IN `grp_id` INT(11), IN `comp_id` INT(11), IN `pro_grp_id` INT(11))
SELECT mpro.id, mpro.name AS pro_name, 
mpro.product_code, 
