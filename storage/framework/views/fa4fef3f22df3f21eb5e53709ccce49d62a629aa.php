...
Phone:</p>
            ...
            <div id="logo">
              <img id="image" src="<?php echo e(asset("assets/images/logo.png")); ?>" alt="logo" width="100px" height="50px">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				  ...
				  <tr>
				      ...
				      <td class="total-value"><div id="total"><?php echo e($total_w_vat); ?> Taka</div></td>
				  </tr>
				  <tr>
				      <td colspan="2" class="blank"> </td>
				  ...
				  <tr>
				      ...
				      <td class="total-value balance"><div class="due">Nill</div></td>
				  </tr>
				   
		</table>
		<h5>In word:<?php  $word=App\Http\Controllers\sale\SaleManagement::getnumbertoWord($total_w_vat);
