            ...
            <div class="purchase_table_input sales_table_input">
                <div class="purchase_table_left col-sm-5">
                        ...
                        <div class="col-md-12">
                                <div class="col-md-6">
                                    ...
                                    <input required class="form-control" type="text" id="order_no" name="order_no" value="<?php echo e($unique); ?>" readonly>
                                </div>
                ...
                <div class="col-md-12   purchase_table_right_bottom">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-control input_required" name="chart_of_acc" id="chart_of_acc">
                ...
                <form action="<?php echo e(Route('product_sale_add_action')); ?>" method="post" role="form" id="form" >
                    ...
                    <div class="col-md-12" style="padding-right: 0px; margin-top: 10px;">
                        <div class="form-group col-sm-2 pull-right" style="padding-right: 0px;">
                            <input required class="form-control input_required btn btn-primary save_btn" style="float: right;" type="submit" disabled value="Submit" >
                        </div>
                    </div>
                </form>
            </div>
