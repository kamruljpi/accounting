                    ...
                    <li class="all_input_li_1">
                        <div id="journal_post_top" class="col-md-12">
                            <div class="col-md-4">
                                ...
                                <?php echo e(Form::text('amount[]', '', ['class'=>'amount form-control', 'id'=>'amount_top','name'=>'amount[]'])); ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <?php echo e(Form::select('members[]', [], null, ['class'=>'members form-control', 'disabled'=> true,'name'=>'members[]'])); ?>



                                <label class="transaction_span">Transaction Type</label>
                                <?php echo e(Form::select('transaction_type[]',[ 'Select Type','1' => 'Payment','2' => 'Receive'],null, ['class'=>'transaction_type form-control','name'=>'transaction_type[]'])); ?>
                    ...
                    <li class="input_li_btm">
                        <div id="journal_post_bottom" class="col-md-12 journal_post_bottom">
                            <div class="col-md-4">
                                ...
                                <?php echo e(Form::text('amount_bottom', '', ['class'=>'amount_bottom form-control', 'id'=>'amount_bottom','name'=>'amount_bottom'])); ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <?php echo e(Form::date('journal_date_bottom',null,['class'=>'journal_date_bottom form-control','name'=>'journal_date_bottom'])); ?>



                                <label class="members_span">Members</label>
                                <?php echo e(Form::select('members_bottom', [], null, ['class'=>'members_bottom form-control','disabled'=> true,'name'=>'members_bottom'])); ?>


                                <label class="transaction_span">Transaction Type</label>
                                <?php echo e(Form::select('transaction_type_bottom',[ 'Select Type','1' => 'Payment','2' => 'Receive'], null, ['class'=>'transaction_type_bottom form-control','name'=>'transaction_type_bottom'])); ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <?php echo e(Form::hidden('particulars', '', ['class'=>'particulars_bottom form-control','readonly'=>'true','name'=>'particulars_bottom','id'=>'particulars_bottom'])); ?>
