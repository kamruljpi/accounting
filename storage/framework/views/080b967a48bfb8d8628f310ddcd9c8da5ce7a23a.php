<?php $__env->startSection('page_heading',trans('others.heading_sale_products_list_label')); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="client_id" class="myselect input_required" required>
                                ...
                                <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($client->chart_o_acc_head_id); ?>"<?php echo e(((Session::get('client_id_for_select_field')) == $client->chart_o_acc_head_id)? "selected":""); ?>
                        ...
                        <div class="col-md-3">
                            <select name="invoice_id" class="myselect">
                                <option value=""><?php echo e(trans('others.option_select_invoice_label')); ?></option>
                        ...
                        <div class="col-md-2">
                            <input type="date" class="form-control" placeholder="<?php echo e(trans('others.search_date_placeholder')); ?>" name="dateSearchFldFrom" id="dateSearchFldFrom" value="<?php echo e(Session::get('fromDate')); ?>" >
                            <p id="search"></p>
                        </span>
                        </div>

                        <div class="col-md-2">
                            <input type="date" class="form-control" placeholder="<?php echo e(trans('others.search_date_placeholder')); ?>" name="dateSearchFldTo" id="dateSearchFldTo" value="<?php echo e(Session::get('toDate')); ?>">
                            <p id="search"></p>
                        </span>
                        </div>
                ...
                <table class="table table-bordered purchase_table" id="tblSearch">
                    <thead>
                        <tr>
                            ...
                            <th class=""><?php echo e(trans('others.date_label')); ?></th>
                            <th class=""><?php echo e(trans('others.company_name_label')); ?></th>
                            <th class=""><?php echo e(trans('others.invoice_no_label')); ?></th>
                            <th class=""><?php echo e(trans('others.product_name_label')); ?></th>
                            <th class=""><?php echo e(trans('others.quantity_per_kg_label')); ?></th>
                            <th class=""><?php echo e(trans('others.unit_price_per_kg_label')); ?></th>
                            <th class=""><?php echo e(trans('others.quantity_label')); ?>t</th>
                            <th class=""><?php echo e(trans('others.total_uptodate_quantity_label')); ?></th>
