				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" role="form" method="POST" action="<?php echo e(Route('acc_sub_class_create_action')); ?>">
							...
							<?php endif; ?>
							<?php echo e(old('account_head_name')); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input type="text" class="form-control input_required" name="acc_sub_class_name" autocomplete="off" value="<?php echo e(old('acc_sub_class_name')); ?>">
								</div>
							</div>
