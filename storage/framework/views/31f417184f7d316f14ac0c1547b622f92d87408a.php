			...
			<div class="col-md-8 col-md-offset-2">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<form class="form-horizontal" role="form" method="POST" action="<?php echo e(Route('chart_of_acc_update_action')); ?>" id="acc_update_form">
								...
								<div class="col-md-6">
									<select class="form-control input_required" name="account_head_name" required id="account_head_name">
                                    	...
                                    	<?php $__currentLoopData = $accounts_heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accounts_head): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($accounts_head->accounts_heads_id); ?>" <?php echo e((old('account_head_name',$chart_of_acc_name->accounts_heads_id) == $accounts_head->accounts_heads_id)? 'selected' : ''); ?>><?php echo e($accounts_head->head_name_type.'('.$accounts_head->account_code.')'); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
								</div>
							</div>
								...
								<div class="col-md-6">
									<select class="form-control input_required" name="account_sub_head_name" id="account_sub_head_name" required  >
                                    	...
                                    	<?php $__currentLoopData = $accounts_sub_heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accounts_sub_head): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        	<option value="<?php echo e($accounts_sub_head->accounts_sub_heads_id); ?>" <?php echo e((old('account_sub_head_name',$chart_of_acc_name->accounts_sub_heads_id) == $accounts_sub_head->accounts_sub_heads_id)? "selected":""); ?>><?php echo e($accounts_sub_head->sub_head); ?></option>
                                    	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
								</div>
							</div>
								...
								<div class="col-md-6">
									<select class="form-control input_required" name="account_head_class_name" id="account_head_class_name" required   >
                                    	...
                                    	<?php $__currentLoopData = $acc_class; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acc_clas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($acc_clas->mxp_acc_classes_id); ?>" <?php echo e((old('account_head_class_name',$chart_of_acc_name->mxp_acc_classes_id) == $acc_clas->mxp_acc_classes_id)? 'selected' : ''); ?>><?php echo e($acc_clas->head_class_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
								</div>
							</div>
								...
								<div class="col-md-6">
									<select class="form-control input_required" name="account_head_sub_class_name" id="account_head_sub_class_name"    required>
                                        ...
                                        <?php $__currentLoopData = $acc_sub_class; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acc_sub_clas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($acc_sub_clas->mxp_acc_head_sub_classes_id); ?>" <?php echo e(((old('account_head_sub_class_name',$chart_of_acc_name->mxp_acc_head_sub_classes_id)) == $acc_sub_clas->mxp_acc_head_sub_classes_id)? 'selected' : ''); ?>><?php echo e($acc_sub_clas->head_sub_class_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input type="text" class="form-control input_required" name="chart_of_acc_name" autocomplete="off" value="<?php echo e(old('acc_sub_class_name',$chart_of_acc_name->acc_final_name)); ?>">
								</div>
							</div>
