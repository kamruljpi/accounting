                            ...
                            <div class="purchase_table_left col-sm-7">
                                ...
                                <div class="col-md-12   purchase_table_right_bottom">
                                   <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control" type="text" name="total_price_with_vat_tax" id="total_price_with_vat_tax" readonly value="<?php echo e(isset($vattaxes[0])? $vattaxes[0]->total_amount_with_vat:0); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 row paid_due_right_bottom">
                                   ...
                                   <div class="col-md-4">
                                        ...
                                        <input class="form-control" type="text" name="paid_amount" value="<?php echo e(isset($vattaxes[0])? $vattaxes[0]->total_amount_with_vat-$purchaseProduct->due_amount:0); ?>" readonly id="paid_amount">
                                    </div>
                                    <input type="hidden" name="root_paid_amount" value="<?php echo e(isset($vattaxes[0])? $vattaxes[0]->total_amount_with_vat-$purchaseProduct->due_amount:0); ?>" id="root_paid_amount">
                                    <div class="col-md-4">
