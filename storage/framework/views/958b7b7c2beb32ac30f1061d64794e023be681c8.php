...
<?php $__env->startSection('section'); ?>
	<div class="col-md-10 col-md-offset-1">
		<div>
			<a href="<?php echo e(Route('add_sub_accounts_head_view')); ?>"> <?php echo $__env->make('widgets.button', array('class'=>'success', 'value'=>'Add Account sub head'), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></a><br><br>
		</div>

		<?php echo $__env->make('layouts.pagination',['route_name'=>'accounts_sub_head_name_view'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
