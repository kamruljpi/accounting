...
<?php $__env->startSection('page_heading',trans('others.heading_add_new_stock_label')); ?>
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<div class="panel panel-default">
					<div class="panel-heading"><?php echo e(trans('others.add_stock_label')); ?></div>
					<div class="panel-body">

						<form class="form-horizontal" role="form" method="POST" action="<?php echo e(Route('add_store_action')); ?>">
