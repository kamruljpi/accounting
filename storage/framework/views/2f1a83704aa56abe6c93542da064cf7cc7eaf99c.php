					...
					<div class="panel-body">
						...
						<form class="form-horizontal" role="form" method="POST" action="<?php echo e(Route('edit_sub_account_head_action')); ?>">
								...
								<div class="col-md-6">
									<select class="form-control input_required" name="account_name" required >
                                        ...
                                        <?php $__currentLoopData = $accounts_heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accounts_head): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($accounts_head->accounts_heads_id); ?>" <?php echo e((old('account_name',$sub_accounts_heads->accounts_heads_id) == $accounts_head->accounts_heads_id)? 'selected' : ''); ?>><?php echo e($accounts_head->head_name_type.'('.$accounts_head->account_code.')'); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input type="text" class="form-control input_required" name="sub_account_name" autocomplete="off" value="<?php echo e(old('sub_account_name',$sub_accounts_heads->sub_head)); ?>">
								</div>
							</div>
