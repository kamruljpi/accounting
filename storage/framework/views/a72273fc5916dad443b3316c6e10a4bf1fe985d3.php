					...
					<div class="panel-body">
						...
						<form class="form-horizontal" role="form" method="POST" action="<?php echo e(Route('edit_account_head_action')); ?>">
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input type="text" class="form-control input_required" name="account_name" autocomplete="off" value="<?php echo e(old('account_name',$account_head->head_name_type)); ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input type="text" class="form-control input_required" name="account_code" autocomplete="off" value="<?php echo e(old('account_code',$account_head->account_code)); ?>">
								</div>
							</div>
