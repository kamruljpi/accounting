...
<?php $__env->startSection('page_heading', 'Party' ); ?>
<?php $__env->startSection('section'); ?>

<?php $__env->startSection('section'); ?>
	<div class="col-md-10 col-md-offset-1">
		<div>
			<a href="<?php echo e(Route('add_new_party')); ?>"> <?php echo $__env->make('widgets.button', array('class'=>'success', 'value'=>'Add party'), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></a><br><br>
		</div>
			...
			<table class="table table-bordered">
	            ...
	            <tbody>
	            	<?php ($i = 1); ?> 
						...
						<tr>
							<td><?php echo e($i++); ?></td>
							<td><?php echo e($chart_of_acc->head_name_type); ?></td>
							...
							<td><a href="<?php echo e(Route('party_update_view')); ?>/<?php echo e($chart_of_acc->chart_o_acc_head_id); ?>"> <?php echo $__env->make('widgets.button', array('class'=>'success', 'value'=>trans('others.edit_button')), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> </a></td>
						</tr>
