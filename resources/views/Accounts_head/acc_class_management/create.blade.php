...
@section('page_heading', 'Add new Account Class')
@section('section')
			...
			<div class="col-md-8 col-md-offset-2">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" role="form" method="POST" action="{{ Route('acc_class_create_action') }}">
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input type="text" class="form-control input_required" name="acc_class_name" autocomplete="off" value="{{ old('acc_class_name') }}">
								</div>
							</div>
