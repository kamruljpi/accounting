        ...
        <div class="col-sm-12">
            ...
            <div class="purchase_table_input lc_purchase_table">
                <div class="purchase_table_left col-sm-5">
                   ...
                   <!--  <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        ...
                        @foreach($lc_Bank_ac as $bank_ac)
                            <option value="{{ $bank_ac->chart_o_acc_head_id }}"> {{ $bank_ac->acc_final_name }} </option>
                        @endforeach
                        </select>
                    </div>
                     <div class="col-md-6">
                        ...
                        @foreach($lc_Bank_loan as $bank_acc_loan)
                            <option value="{{ $bank_acc_loan->chart_o_acc_head_id }}"> {{ $bank_acc_loan->acc_final_name }} </option>
                        @endforeach
                        </select>
                    </div>
                </div>
               ...
               <div class="purchase_table_right col-sm-7">
                    ...
                    <input class="form-control btn btn-primary bank_info_btn" style="float: right;" type="submit" value="Show Bank Info">

                    <div class="col-sm-12 input_table_specific" style="display:none">
                        ...
                        <div class="col-md-12">
                            ...
                            <input class="form-control " type="text" name="swift_charges" id="swift_charges">
                        </div>
                        <div class="col-md-3">
                            <label>Vat(%): </label>
                        ...
                        <div class="col-md-5">
                            ...
                            <input class="form-control " type="text" name="bank_commission" id="bank_commission">
                        </div>
                        <div class="col-md-4">
                            <label>Total Vat: </label>
                            <input class="form-control " type="text" name="total_vat" id="total_vat" readonly>
                        </div>

                        <div class="col-md-12">
                            <label>LC Application From Charges: </label>
                            <input class="form-control " type="text" name="application_form_charges" id="application_form_charges">
                        </div>
                    </div>
            ...
            <div class="purchase_table col-md-12">
                <form action="{{ Route('lc_purchase_table_action') }}" method="post" role="form" id="form" target="_blank">
