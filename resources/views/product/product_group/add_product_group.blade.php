...
@section('page_heading',trans('others.add_new_product_group_label'))
@section('section')
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<div class="panel panel-default">
					<div class="panel-heading">{{ trans('others.add_product_group_label') }}</div>
					<div class="panel-body">

						<form class="form-horizontal" role="form" method="POST" action="{{ Route('add_product_group_action') }}">
